...
class Client implements ActionListener {
    ...
    Client() {
        ...
        p1.setBackground(new Color(0, 80, 80));
        ...
        // profile picture
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Chandan 2.png"));
        ...
        // Account Name
        JLabel name = new JLabel("Chandan Chaudhary");
        ...
        // main text body
        a1 = new JPanel();
        a1.setBounds(8, 80, 432, 560);
        a1.setBackground(new Color(0, 138, 138));
        f.add(a1);
        ...
        send.setBackground(new Color(0, 80, 80));
    ...
    // Massage transfer action --> in the massage box
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBorder(new EmptyBorder(7, 7, 7, 40));
